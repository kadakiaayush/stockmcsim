...
def fetch_stock_data(tickers, period="10y"):
    try:
        ...
        if data.empty:
            st.error("Undergoing construction to become bigger, better, & smarter due to yFinance python library update! Last updated 20:52 EST 05/01/25. Anticipated fully functional with improvements within 48hrs")
            st.stop()
